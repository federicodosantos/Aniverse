                ...
                <div class="px-4 py-6 sm:px-6 lg:px-10">
                    ...
                    @csrf
                        ...
                        <div class="pt-16 flex justify-center items-center">
                            <button class="mx-auto text-white bg-violet-500 rounded-3xl w-1/2 h-12">{{ __('Register') }}</button>
                            <!-- <x-primary-button class="ms-4">
                                {{ __('Register') }}
                            </x-primary-button> -->
                        </div>
                    </form>
                    <a class="flex py-3 justify-center items-center text-center underline text-sm text-white hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('login') }}">
